...
<body>
	...
	*{
	...
	if(isset($_POST['postComment'. $post_id])){
		...
		if($user_to != 'none' && $user_to != $userLoggedIn) // commented on someone's profile???
		{
			$notification = new Notification($con, $userLoggedIn);
	...
	if($count != 0)
	{
		while($comment = mysqli_fetch_array($get_comments)){
			...
			?>
			<div class="comment_section"><!--if target is not specified the profile page will be loaded inside the iframe...-->
